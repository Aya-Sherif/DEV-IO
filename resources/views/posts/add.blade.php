...
@section('content')
    ...
    <div class="col-8 mx-auto">
        ...
        <form method="Post" action="{{ url('posts/store') }}" class="form border p-3 ">
            @csrf
            @if ($errors->any())
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="title"id="title" value="{{old('title')}}" placeholder="Post Title">
            </div>
            <div class="mb-3">
